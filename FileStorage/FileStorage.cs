...
namespace UnitTestEx
{
    public class FileStorage
    {
        ...
        public bool Write(File file) {
            ...
            files.Add(file);
            availableSize -= file.GetSize(); // исправил убран пробел в GetSize()
        ...
        public File GetFile(String fileName)
        {
            if (IsExists(fileName))
            {
                foreach (File file in files)
                {
                    if (file.GetFilename().Equals(fileName)) // Исправлено: Contains на Equals
                    {
                        return file;
                    }
                }
        ...
        {
            files.Clear(); // исправил - было RemoveRange с ошибкой
